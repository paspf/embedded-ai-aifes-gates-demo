/*
  ...
  ---------------------------------------------------------------------------  
    ...
    aifes_e_xnor_gate_f32_fnn_inference((float*)input_data,(float*)output_data);
  ---------------------------------------------------------------------------
...
#ifndef AIFES_E_F32_XNOR_GATE_FNN
#define AIFES_E_F32_XNOR_GATE_FNN

#define DATASETS 1
#define FNN_LAYERS 3

void aifes_e_xnor_gate_f32_fnn_inference(float* input_data, float* output_data)
{
  uint32_t FNN_structure[FNN_LAYERS] = {2, 4, 1};
  ...
  AIFES_E_activations FNN_activations[] = {AIfES_E_sigmoid, AIfES_E_sigmoid};
  ...
  FNN.flat_weights = (void*) model_xnor_gate_flat_weights;

  AIFES_E_inference_fnn_f32(&input_tensor,&FNN,&output_tensor);
}

#endif // AIFES_E_F32_XNOR_GATE_FNN
