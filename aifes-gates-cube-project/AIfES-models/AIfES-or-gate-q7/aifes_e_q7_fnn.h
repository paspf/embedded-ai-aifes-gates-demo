/*
  ...
  ---------------------------------------------------------------------------  
    ...
    aifes_e_or_gate_q7_fnn_inference((float*)input_data,(float*)output_data);
  ---------------------------------------------------------------------------
...
#ifndef AIFES_E_Q7_OR_GATE_FNN
#define AIFES_E_Q7_OR_GATE_FNN

#define DATASETS 1
#define FNN_LAYERS 3

void aifes_e_or_gate_q7_fnn_inference(float* input_data, float* output_data)
{
  ...
  FNN.flat_weights = (void*) model_or_gate_parameters;
