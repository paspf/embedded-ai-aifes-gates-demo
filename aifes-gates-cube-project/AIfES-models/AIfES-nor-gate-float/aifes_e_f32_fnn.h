/*
  ...
  ---------------------------------------------------------------------------  
    ...
    aifes_e_nor_gate_f32_fnn_inference((float*)input_data,(float*)output_data);
  ---------------------------------------------------------------------------
...
#ifndef AIFES_E_F32_NOR_GATE_FNN
#define AIFES_E_F32_NOR_GATE_FNN

#define DATASETS 1
#define FNN_LAYERS 3

void aifes_e_nor_gate_f32_fnn_inference(float* input_data, float* output_data)
{
  ...
  FNN.flat_weights = (void*) model_nor_gate_flat_weights;

  AIFES_E_inference_fnn_f32(&input_tensor,&FNN,&output_tensor);
}

#endif // AIFES_E_F32_NOR_GATE_FNN
