/*
  ...
  ---------------------------------------------------------------------------  
    ...
    aifes_e_and_gate_q7_fnn_inference((float*)input_data,(float*)output_data);
  ---------------------------------------------------------------------------
...
#ifndef AIFES_E_Q7_AND_GATE_FNN
#define AIFES_E_Q7_AND_GATE_FNN

#define DATASETS 1
#define FNN_LAYERS 3

void aifes_e_and_gate_q7_fnn_inference(float* input_data, float* output_data)
{
  ...
  FNN.flat_weights = (void*) model_and_gate_parameters;
